  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Идеология — это не просто набор идей. Это способ, которым государство объясняет себя самому себе и своим гражданам, придавая власти смысл и легитимность.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Клод Леви-Стросс</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Структурная антропология</p>
        </div>
      </div>
    </section>
  )
