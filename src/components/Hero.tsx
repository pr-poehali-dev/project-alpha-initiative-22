  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Академический доклад · История России
        </p>
        ...
        >
          Государственная
          <span className="block text-sage">идеология России</span>
        </h1>
        ...
        >
          Исторический опыт формирования государственной идеологии: от православно-самодержавных концепций до советского проекта и современности.
        </p>
